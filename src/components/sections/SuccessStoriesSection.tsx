  ...
  const stories = [
    {
      ...
      quote: '「もう諦めようと思っていたんです。でも、5レンジャーなら600万円で。あの時の"やってやる！"という気持ちが蘇りました。長年の夢だった農家支援事業をついに始めることができました。」',
    ...
    },
    {
      ...
      quote: '「大手には勝てない、そう思っていました。でも5レンジャーで開発したシステムが評判になり、今では31社が導入。夢のような話が現実になったんです。」',
